...
<body>
    ...
    <div class="room-page">
        <div class="filter-container mb-3">
            ...
            <button class="changeDates" onclick="window.location.href='getDates.jsp'">Change Dates</button>
        </div>
    ...
    <script>
        function setModalFields(row) {
            ...
            document.getElementById("modal-form").action = "book-room-controller.jsp";
