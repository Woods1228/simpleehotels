...
<body>
                ...
                <div class="modal-body">
                    <form id="modal-form">
                        <div style="text-align: center;">
                            ...
                            <input type="text" name="num_of_rooms" id="num_of_rooms"></br>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        data-toggle="modal" 
                                        data-address="<%= hotel.getAddress() %>"
                                        data-num_of_rooms="<%= hotel.getNumOfRooms() %>"
                                        data-email="<%= hotel.getEmail() %>"
                                        data-stars="<%= hotel.getStars() %>"
                                        data-chain_address="<%= hotel.getChainAddress() %>"
    ...
    <script>
        function setModalFields(row) {
            ...
            document.getElementById("num_of_rooms").value = row.dataset.num_of_rooms;
            document.getElementById("email").value = row.dataset.email;
            document.getElementById("stars").value = row.dataset.stars;
            document.getElementById("chain_address").value = row.dataset.chain_address;
